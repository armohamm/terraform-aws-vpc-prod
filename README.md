...
Configuration in this directory creates set of VPC resources which may be sufficient for staging or production environment (look into <a href="https://github.com/armohamm/terraform-simplevpc-aws" target="_blank"> terraform-simplevpc-aws
</a> for more simplified setup with Single NAT gateway).
